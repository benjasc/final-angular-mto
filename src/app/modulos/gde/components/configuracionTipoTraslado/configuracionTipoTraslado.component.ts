...
@Component({
  selector: 'app-configuraciontipotraslado',
  templateUrl: './configuracionTipoTraslado.component.html',
  styleUrls: ['./configuracionTipoTraslado.component.scss']
})
export class ConfiguracionTrasladoComponent implements OnInit, OnDestroy, AfterViewInit {
