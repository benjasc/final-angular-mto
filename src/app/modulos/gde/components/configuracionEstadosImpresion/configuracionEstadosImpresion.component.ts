...
@Component({
  selector: 'app-configuracionestadosimpresion',
  templateUrl: './configuracionEstadosImpresion.component.html',
  styleUrls: ['./configuracionEstadosImpresion.component.scss']
})
export class ConfiguracionEstadoImpresionComponent implements OnInit, OnDestroy, AfterViewInit {
