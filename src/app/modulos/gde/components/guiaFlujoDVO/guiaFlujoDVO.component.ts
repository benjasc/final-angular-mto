...
@Component({
  selector: 'app-guiaflujodvo',
  templateUrl: './guiaFlujoDVO.component.html',
  styleUrls: ['./guiaFlujoDVO.component.scss']
})
export class GuiaFlujoDVOComponent implements OnInit, OnDestroy, AfterViewInit {
