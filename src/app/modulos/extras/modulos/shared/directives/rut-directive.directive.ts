...
export class RutDirective {
  rut: String;
  @Output() rutFormateado = new EventEmitter();
  @Output() rutSinFormato = new EventEmitter();
  ...
  @HostListener('blur') blur() {
    ...
    if (this.rutValidate(this.rut)) {
      ...
      this.rutSinFormato.emit(this.rut);
      this.rut = this.rutFormat(this.rut);
      this.el.nativeElement.value = this.rut;
      this.rutFormateado.emit(this.rut);
    } else {
      this.el.nativeElement.value = '';
      this.el.nativeElement.innerText = '';
      this.rutFormateado.emit('');
      this.rutSinFormato.emit('');
    }
  }
