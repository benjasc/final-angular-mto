...
export class OrderComponent implements OnInit {
  ...
  doSearchDetailInfoOrdenCompra(oc: String) {
    ...
    this.searchInfo.searchDetailInfoOrdenCompra('' + oc).subscribe((res: any) => this.ret = res,
    (err) => {
      ...
      this.messageService.enviarMensaje('Error búsqueda', ['Error en servicio de búsqueda detalle'], 'info', this.dialogService);
        ...
        if (this.ret.code === 0 && this.ret.code !== undefined) {
          ...
          this.saleDetail = this.utils.validarRespuestaFormatear(this.ret);
  ...
  doSearchDetailInfoProducto(oc: String) {
    ...
    this.searchInfo.searchDetailInfoProducto('' + oc).subscribe((res: any) => this.ret = res,
    (err) => {
    ...
    () => {
        if (this.ret.code === 0 && this.ret.code !== undefined) {
          ...
          console.log(this.ret);
          this.productDetailList = this.utils.validarRespuestaFormatear(this.ret);
  ...
  doSearchDetailInfoMedioPago(oc: String) {
    ...
    this.searchInfo.searchDetailInfoMedioPago('' + oc).subscribe((res: any) => this.ret = res,
    (err) => {
    ...
    () => {
        if (this.ret.code === 0 && this.ret.code !== undefined) {
          ...
          console.log(this.ret);
          this.mpagoDetailList = this.utils.validarRespuestaFormatear(this.ret);
  ...
  doSearchDetailInfoOrdenDespacho(oc: String) {
    ...
    this.searchInfo.searchDetailInfoOrdenDespacho('' + oc).subscribe((res: any) => this.ret = res,
    (err) => {
    ...
    () => {
        if (this.ret.code === 0 && this.ret.code !== undefined) {
          ...
          console.log(this.ret);
          this.shippingOrderDetailList = this.utils.validarRespuestaFormatear(this.ret);
  ...
  doSearchDetailInfoNovios(oc: String) {
    ...
    this.searchInfo.searchDetailInfoNovios('' + oc).subscribe((res: any) => this.ret = res,
    (err) => {
      ...
      this.messageService.enviarMensaje('Error búsqueda', ['Error en servicio de búsqueda detalle'], 'info', this.dialogService);
        ...
        if (this.ret.code === 0 && this.ret.code !== undefined) {
          ...
          console.log(this.ret);
          this.ppeDetailList = this.utils.validarRespuestaFormatear(this.ret);
  ...
  doSearchDetailInfoTransaction(oc: String) {
    ...
    this.searchInfo.searchDetailInfoTransaction('' + oc).subscribe((res: any) => this.ret = res,
    (err) => {
      this.recargarTransaccion = true;
        ...
        if (this.ret.code === 0 && this.ret.code !== undefined) {
          ...
          console.log(this.ret);
          this.trxDetailList = this.utils.validarRespuestaFormatear(this.ret);
  ...
  doSearchDetailInfoShipping(oc: String) {
    ...
    this.searchInfo.searchDetailInfoShipping('' + oc).subscribe((res: any) => this.ret = res,
    (err) => {
      this.recargarDespacho = true;
        console.log(<any>err);
        this.messageService.cargando(false);
  ...
  doSearchDetailInfo2(oc: String) {
    ...
    this.searchInfo.searchDetailInfo2('' + oc).subscribe((res: any) => this.ret = res,
    (err) => {
      console.log('error');
      console.log(err);
      this.messageService.enviarMensaje('Error búsqueda', ['Info no válido'], 'info', this.dialogService);
        ...
        if (this.ret.code === 0 && this.ret.code !== undefined) {
          ...
          console.log(this.ret);
          this.resultsDetail = this.utils.validarRespuestaFormatear(this.ret);
  ...
  searchShippingOrderInfoDetail(oc, idShipping) {
    ...
    this.searchInfo.searchShippingOrderToInfoDetail(oc, idShipping).subscribe((res: any) => this.ret = res,
    (err) => {
      console.log('error');
      console.log(err);
    }, () => {  
        if (this.ret.code === 0 && this.ret.code !== undefined) {
          ...
          console.log(this.ret);
          this.resultsShippingDetail.shippingOrderToInfoDetail = this.utils.validarRespuestaFormatear(this.ret);
