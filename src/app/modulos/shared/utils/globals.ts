...
*/
    themeApp(data) {
        ...
        if ('ripley' === data) {
            ...
            this.config.push({
                theme: data,
                chartColorOne: CONSTANTS.COLORS.RIPLEY.PRIMARY,
                chartColorTwo: CONSTANTS.COLORS.RIPLEY.PRIMARY_MEDIUM,
            });

            document.documentElement.style.setProperty('--color-1', CONSTANTS.COLORS.RIPLEY.PRIMARY);
            document.documentElement.style.setProperty('--color-2', CONSTANTS.COLORS.RIPLEY.PRIMARY_MEDIUM);
            document.documentElement.style.setProperty('--color-3', CONSTANTS.COLORS.RIPLEY.PRIMARY_LIGHT);
            document.documentElement.style.setProperty('--color-4', CONSTANTS.COLORS.RIPLEY.GRAY);
            document.documentElement.style.setProperty('--color-5', CONSTANTS.COLORS.RIPLEY.GRAY_MEDIUM);
            document.documentElement.style.setProperty('--color-7', CONSTANTS.COLORS.RIPLEY.GRAY_LIGHT);
            document.documentElement.style.setProperty('--color-8', CONSTANTS.COLORS.RIPLEY.SECONDARY_ONE);
            document.documentElement.style.setProperty('--color-9', CONSTANTS.COLORS.RIPLEY.SECONDARY_TWO);
            document.documentElement.style.setProperty('--color-10', CONSTANTS.COLORS.RIPLEY.SECONDARY_THREE);
            document.documentElement.style.setProperty('--color-11', CONSTANTS.COLORS.RIPLEY.SECONDARY_FOUR);
            document.documentElement.style.setProperty('--color-12', CONSTANTS.COLORS.RIPLEY.SECONDARY_FIVE);
            document.documentElement.style.setProperty('--color-13', CONSTANTS.COLORS.RIPLEY.SECONDARY_SIX);
        }
    }
